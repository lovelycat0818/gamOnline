...
import pysot.tracker.classifier.libs.complex as complex
...
def cfft2(a):
    ...
    out = torch.fft.fft2(a, dim=(-2, -1))
    out = torch.stack((out.real, out.imag), -1)
    return rfftshift2(out)
...
def cifft2(a, signal_sizes=None):
    ...
    # return torch.fft.irfft2(irfftshift2(a), 2, signal_sizes=signal_sizes)
