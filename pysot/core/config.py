...
__C.DATASET.GOT10K.ROOT = '/home/user/TrackingDataset/GOT10K-crop511'
__C.DATASET.GOT10K.ANNO = '/home/user/TrackingDataset/GOT10K-crop511/train.json'
__C.DATASET.GOT10K.FRAME_RANGE = 100
__C.DATASET.GOT10K.NUM_USE = 100000

__C.DATASET.LASOT = CN()
__C.DATASET.LASOT.ROOT = '/home/user/TrackingDataset/LaSOT-crop511'
__C.DATASET.LASOT.ANNO = '/home/user/TrackingDataset/LaSOT-crop511/train.json'
__C.DATASET.LASOT.FRAME_RANGE = 100
__C.DATASET.LASOT.NUM_USE = 100000

__C.DATASET.VIDEOS_PER_EPOCH = 100000
# ------------------------------------------------------------------------ #
# Backbone options
# ------------------------------------------------------------------------ #
__C.BACKBONE = CN()
...
__C.BACKBONE.PRETRAINED = '/home/code/gamOnline_v2/tools/pretrained_models/resnet50.model'
...
__C.GAM.KWARGS  = CN(new_allowed=True)
